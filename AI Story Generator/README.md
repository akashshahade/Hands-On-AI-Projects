...
- ðŸŽ¨ **Multiple Genres**: Fantasy, Sci-Fi, Mystery, Romance, Horror, and more
- ðŸ“ **Adjustable Length**: Short, Medium, or Long stories
- âœï¸ **Writing Styles**: Descriptive, Dialogue-heavy, Fast-paced, Poetic, Simple
- ðŸ‘¥ **Custom Characters**: Add your own character names
- ðŸŽ­ **Optional Details**: Specify setting, conflict, and tone
- ðŸ’¾ **Download Stories**: Save your generated stories as text files
- ðŸŽ¯ **Clean UI**: Beautiful, easy-to-use interface
